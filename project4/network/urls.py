...
urlpatterns = [
    ...
    path(
        "get-posts-for-user-profile/<str:username>",
        views.get_posts_for_user_profile,
        name="get_posts_for_user_profile",
    ),
    path("post/<int:user_id>/<int:post_id>", views.post, name="post"),
    path("follow/<str:username>", views.follow, name="follow"),
    path(
        "get-user-status/<str:username>", views.get_user_status, name="get_user_status"
    ),
    path(
        "get-current-user-info", views.get_current_user_info, name="current_user_info"
    ),
]
